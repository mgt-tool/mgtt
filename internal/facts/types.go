...
type StoreMeta struct {
	...
	// Suspects is the agent's initial suspicion — raw "component" or
	// "component.state" hints captured at incident.start so every
	// subsequent plan/probe biases probe ordering the same way.
	Suspects []string `yaml:"suspects,omitempty"`
}
